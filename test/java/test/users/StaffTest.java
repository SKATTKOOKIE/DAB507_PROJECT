...
class StaffTest
{
    ...
    class DepartmentTests
    {
        ...
        void testGetDepartmentIdWithNull()
        {
            ...
            assertEquals(DepartmentId.UNKNOWN, nullDeptStaff.getDepartmentId(),
        ...
        void testGetDepartmentIdWithEmpty()
        {
            ...
            assertEquals(DepartmentId.UNKNOWN, emptyDeptStaff.getDepartmentId(),
                    "Empty department should return UNKNOWN");
        ...
        void testGetDepartmentIdWithInvalid()
        {
            ...
            assertEquals(DepartmentId.UNKNOWN, invalidDeptStaff.getDepartmentId(),
                    "Invalid department should return UNKNOWN");
    ...
    class OutputTests
    {
        ...
        void testToString()
        {
            ...
            assertTrue(result.contains("Weekly Hours: " + TEST_WEEKLY_HOURS),
                    "toString should contain weekly hours");
            assertTrue(result.contains("Max Modules: " + TEST_MAX_MODULES),
        ...
        void testPrintDetailedInfo()
        {
            ...
            assertTrue(output.contains(TEST_DEPARTMENT.getDepartmentName()),
                    "Output should contain department name");
            assertTrue(output.contains(String.valueOf(TEST_WEEKLY_HOURS)),
                    "Output should contain weekly hours");
            assertTrue(output.contains(String.valueOf(TEST_MAX_MODULES)),
